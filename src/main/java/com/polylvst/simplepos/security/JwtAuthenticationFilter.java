    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try{
            ...
            if (token != null){
                ...
                if (userDetails instanceof MyUserDetailsImpl) {
                    request.setAttribute("userId", ((MyUserDetailsImpl) userDetails).getId());
                }
            }
        }
        catch (Exception e)
        {
//            Hiraukan jika terjadi exception, dan jangan authenticate user
